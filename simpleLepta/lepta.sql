--
-- Файл сгенерирован с помощью SQLiteStudio v3.4.3 в Вт мар 14 16:11:21 2023
--
...
-- Таблица: achievments
CREATE TABLE IF NOT EXISTS achievments (id_event INTEGER REFERENCES events (id) NOT NULL, id_volunteer INTEGER REFERENCES volunteer (id), content TEXT NOT NULL);
...
-- Таблица: books
CREATE TABLE IF NOT EXISTS books (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT NOT NULL, author TEXT NOT NULL, date TEXT NOT NULL);
...
CREATE TABLE IF NOT EXISTS evangelical_group (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT NOT NULL);
...
-- Таблица: events
CREATE TABLE IF NOT EXISTS events (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT NOT NULL, datetime TEXT NOT NULL, id_type INTEGER NOT NULL REFERENCES types_event (id), content TEXT NOT NULL);
...
-- Таблица: library
CREATE TABLE IF NOT EXISTS library (id_reader INTEGER NOT NULL REFERENCES volunteer (id), id_book INTEGER REFERENCES books (id));
...
-- Таблица: news
CREATE TABLE IF NOT EXISTS news (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, heading TEXT NOT NULL, text TEXT NOT NULL, date TEXT NOT NULL);
...
-- Таблица: roles
CREATE TABLE IF NOT EXISTS roles (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title TEXT NOT NULL);
...
-- Таблица: types_event
CREATE TABLE IF NOT EXISTS types_event (id INTEGER PRIMARY KEY AUTOINCREMENT, name_type TEXT NOT NULL);
...
-- Таблица: volunteer
CREATE TABLE IF NOT EXISTS volunteer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT NOT NULL, age INTEGER NOT NULL DEFAULT (0), religion TEXT NOT NULL DEFAULT Православие, sex TEXT NOT NULL DEFAULT муж, phone_number TEXT NOT NULL DEFAULT нет, id_evangelical_group INTEGER REFERENCES evangelical_group (id) NOT NULL, id_role INTEGER REFERENCES roles (id));
INSERT INTO volunteer (id, name, age, religion, sex, phone_number, id_evangelical_group, id_role) VALUES (1, 'Ратибор', 20, 'Православие', 'муж', '89173340197', 1, 1);
...
INSERT INTO volunteer (id, name, age, religion, sex, phone_number, id_evangelical_group, id_role) VALUES (3, 'Андрей Козякин', 20, 'Невоцерковленный', 'муж', 'нет', 3, 8);
